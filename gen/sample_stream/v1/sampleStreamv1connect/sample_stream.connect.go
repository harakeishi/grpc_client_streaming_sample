...
const (
	// SampleStreamServiceName is the fully-qualified name of the SampleStreamService service.
	SampleStreamServiceName = "sample_stream.v1.SampleStreamService"
)
...
// period.
const (
	// SampleStreamServiceSampleClientStreamProcedure is the fully-qualified name of the
	// SampleStreamService's SampleClientStream RPC.
	SampleStreamServiceSampleClientStreamProcedure = "/sample_stream.v1.SampleStreamService/SampleClientStream"
)
...
func NewSampleStreamServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SampleStreamServiceClient {
	...
	return &sampleStreamServiceClient{
		sampleClientStream: connect.NewClient[v1.SampleClientStreamRequest, v1.SampleClientStreamResponse](
			httpClient,
			baseURL+SampleStreamServiceSampleClientStreamProcedure,
...
// sampleStreamServiceClient implements SampleStreamServiceClient.
type sampleStreamServiceClient struct {
	sampleClientStream *connect.Client[v1.SampleClientStreamRequest, v1.SampleClientStreamResponse]
}
...
func NewSampleStreamServiceHandler(svc SampleStreamServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/sample_stream.v1.SampleStreamService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case SampleStreamServiceSampleClientStreamProcedure:
			sampleStreamServiceSampleClientStreamHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
